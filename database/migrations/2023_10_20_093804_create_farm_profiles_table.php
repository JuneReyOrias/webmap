...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('farm_profiles', function (Blueprint $table) {
            ...
            $table->timestamps();
            // $table->foreign('farmer_no')
            // ->references('farmer_no') // Assuming 'farmer_no' is the primary key in 'personal_informations'
    ...
    public function down(): void
    {
        Schema::dropIfExists('farm_profiles');
         Schema::dropForeign(['farmer_no']);
         Schema::dropColumn('farmer_no');
    }
};
