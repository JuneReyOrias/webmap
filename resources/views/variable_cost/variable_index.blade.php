...
<div class="page-content">
  ...
  <div class="progress mb-3">
    <div class="progress-bar progress-bar-striped bg-succcess" role="progressbar" style="width: 85%;" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100">85% Complete</div>
  ...
  <div class="row">
    <div class="col-md-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h6 class="card-title"><span>VII.</span>Variable Cost</h6>
