      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         {{-- <p class="text-muted mb-3">Read the <a href="https://github.com/RobinHerbots/Inputmask" target="_blank"> Official Inputmask Documentation </a>for a full list of instructions and other options.</p> --}}
          <form action{{url('agri_districts')}} method="post">
            @csrf
            <div class="row mb-3">
              ...
              <div class="col-md-3">
                ...
                <div class="form-floating mb-4 mb-md-0"> 
                   <select class="form-control mb-4 mb-md-0" name="users_id" aria-label="User ID">
                    ...
                    <label for="users_id">Users Name:</label>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating mb-4 mb-md-0">
                <input  class="form-control mb-4 mb-md-0" name="district" placeholder="FirstName" type="text" aria-label="FirstName"id="floatingInput">
            ...
            <div class="col-md-3">
              <div class="form-floating mb-4 mb-md-0">
              <input  class="form-control mb-4 mb-md-0" name="description" placeholder="MiddleName" type="text" aria-label="MiddleName"id="floatingInput">
